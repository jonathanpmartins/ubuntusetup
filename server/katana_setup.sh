...
apt_get_packages=( "htop" "unzip" "git" "git-core" "nodejs-legacy" "npm" "mysql-server" "php5-mysql" "php5-fpm" "php5-cli" "php5-json" "php5-mcrypt" "mcrypt" "php5-curl" "curl" "php5-gd" "nginx" );
