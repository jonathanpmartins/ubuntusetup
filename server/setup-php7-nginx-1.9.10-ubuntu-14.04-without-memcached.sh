...
apt_get_packages=( "git" "mcrypt" "php7.0" "php7.0-dev" "php7.0-fpm" "php7.0-mysql" "php7.0-cli" "php7.0-common" "php7.0-json" "php7.0-curl" "php7.0-mcrypt" "php7.0-readline" "php-mongodb" "php-redis" ); # "python-pip"
