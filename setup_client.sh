...
apt_get_packages=("google-chrome-stable" "brackets" "sublime-text-installer" "git" "curl" "git-core" "gitk" "gitg" "git-gui" "nodejs-legacy" "npm" "mysql-server" "php5-mysql" "php5-fpm" "php5-cli" "php5-mcrypt" "php5-curl" "php5-json" "php5-gd" "php5-xdebug" "nginx" "ruby-full" "phantomjs" "filezilla" "virtualbox" "virtualbox-dkms" "vagrant" "skype" "docker.io" "python-pip" "meld" "inotify-tools" "openjdk-7-jre" "oracle-java8-installer" "whois" "mytop" "jmeter" "awscli" "ec2-api-tools");
